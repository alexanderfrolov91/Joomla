...
INSERT INTO `owtqe_languages` VALUES (1,0,'en-GB','English (en-GB)','English (United Kingdom)','en','en_gb','','','','',1,1,2),(2,60,'ru-RU','Russian (ru-RU)','Русский (Россия)','ru','ru_ru','','','','',1,1,1);
...
INSERT INTO `owtqe_virtuemart_categories_ru_ru` VALUES (1,'категория','','','','','категория');
...
INSERT INTO `owtqe_virtuemart_paymentmethods_ru_ru` VALUES (1,'наличными','','наличными');
...
INSERT INTO `owtqe_virtuemart_products_ru_ru` VALUES (1,'','','товар','','','','товар');
...
INSERT INTO `owtqe_virtuemart_shipmentmethods_ru_ru` VALUES (1,'самовывоз','','самовывоз');
