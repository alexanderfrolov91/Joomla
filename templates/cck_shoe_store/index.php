...
$doc->addStyleSheet($this->baseurl."/templates/".$this->template."/css/icomoon.css");
						        ...
						        <i class="fa fa-bars"></i>
								    <?php if ($this->countModules('Menu_button_text')): ?>
										<div class="button_text">
											<jdoc:include type="modules" name="Menu_button_text" style="xhtml" />
										</div>
									<?php endif; ?>
						      </button>
						    </div>
	...
	<div class="container">
		...
		<div id="wrapper">
		    ...
		    <?php if ($this->countModules('Slideshow-left') || $this->countModules('Slideshow-right')): ?>
				<div class="main_slider row full-width">
					<div class="col-sm-10 col-xs-12">
						<jdoc:include type="modules" name="Slideshow-left" style="xhtml" />
					</div>
					<div class="col-sm-2 col-xs-12">
						<jdoc:include type="modules" name="Slideshow-right" style="xhtml" />
					</div>
				</div>
			<?php endif; ?>
			...
			<div class="container">
			 	<div class="row ">
					<?php if ($left): ?>
					      <div class="sidebar-left col-lg-2 col-md-2 col-sm-2 col-xs-12"><jdoc:include type="modules" name="SidebarLeft" style="xhtml" /></div>
					<?php endif; ?>
						...
						<div id="contentBox" class="<?php if ($left && $right) {print('col-lg-8 col-md-8 col-sm-8 col-xs-12');} else if ($left || $right) {print('col-lg-10 col-md-10 col-sm-10 col-xs-12');} else {print('col-lg-12 col-md-12 col-sm-12 col-xs-12');} ?>">
							<div class="component_wrapper">
								...
								<div class="central_content">
									<jdoc:include type="modules" name="Central_content" style="xhtml" />
								</div>
							</div>
						</div>
				...
				<div class="container">
					<div class="row">
						<div class="tabs_block">
					    	<jdoc:include type="modules" name="tabs_block" style="xhtml" />
					    </div>
					</div>
				</div>
		    <?php endif; ?>
			...
			<?php if ($this->countModules('position-top-center')): ?>
				<div class="top_section_bg" id="top_section">
					<div class="container">
						<div  class="row">
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<jdoc:include type="modules" name="position-top-center" style="xhtml" />
							</div>
						</div>
					</div>
				</div>
